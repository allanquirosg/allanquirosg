👋 Hola, soy Ingeniero FinTech


Backend Developer • Data Analyst • Banking Systems

Software engineer con 8+ años de experiencia en sector financiero. Especializado en arquitectura de bases de datos, desarrollo backend y análisis de sistemas críticos.
Combino habilidades técnicas (Python, C#, SQL Server) con comprensión profunda de operaciones bancarias, permitiendo puentes efectivos entre equipos técnicos y negocio.

Ubicación: Costa Rica | Disponibilidad: Inmediata | Modalidad: Abierto a opciones
...
💾 Proyecto: BancoVentas
Estado: Arquitectura y diseño completados
...
Análisis de Datos y Calidad Operativa (Agente de Call Center)
...
Analista de Datos Comerciales & CRM (Agente de Televentas)
...
Lo que puedo aportar ahora mismo:

✅ Conocimiento de negocio bancario: Entiendo procesos, regulación, operaciones críticas

✅ Análisis técnico-operativo: Puedo entender problemas complejos y proponer soluciones

✅ Modelado de datos: Diseño de esquemas relacionales para problemas complejos

✅ SQL avanzado: Queries optimizadas, procedimientos, automatización

✅ Documentación clara: Capacidad de comunicar soluciones técnicas

✅ Ganas de aprender: Activamente certificándome en herramientas modernas
...
💼 LinkedIn: linkedin.com/in/allanquirosgutierrez
